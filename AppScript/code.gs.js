...
function doGet(e) {
  ...
  const json = {}
  const tweetRows = SpreadsheetApp.getActiveSpreadsheet().getSheetByName('tweets').getDataRange().getValues().slice(1)
  ...
  const emailRows = SpreadsheetApp.getActiveSpreadsheet().getSheetByName('emails').getDataRange().getValues()
